...
categories = {
    "Drug Trafficking": [
        ...
        "{charged_with} cultivating marijuana",
        "{charged_with} trafficking offense",
    ],
    "Drug Possession": [
        ...
        "solicitation to unlawfully possess {drug}",
    ...
    "Larceny/Motor Vehicle Theft": [
        ...
        "shoplift less than 250 dollars",
        ...
        "{improper} driving away of motor vehicle",
        "{improper} taking",
    ...
    "Court Violation": [
        ...
        "{charged_with} not registering as a convicted sex offender",
        ...
        "{failure to} give notice of change of address but not to department of motor vehicles",
        "{failure to} verify current residence to court",
        ...
        "contempt of court",
        "contempt",
        "{charged_with} being in contempt",
        "not abiding by court order",
        "{failure to} pay restitution fees",
        ...
        "{failure to} respect a court no-contact order",
    ...
    "Public Order": [
        ...
        "{improper} municipal ordinance violation",
    ...
    "Environmental Violation": [
        ...
        "{possessing} of forest products {without} a permit",
        "fishing - extra lines",
        "fishing in an {improper} way",
        "{improper} recreational fishing",
        "{charged_with} hunting {without} a license",
        "{charged_with} {improper} hunting",
        "{charged_with} chopping down trees in a protected forest",
        "{improper} fishing",
        "{improper} hunting",
        "{charged_with} hunting on national park grounds",
        "{improper} wild camping in a protected area",
        "{improper} chopping down of trees",
    ],
    "Rioting": [
        "rioting",
        "looting",
    ...
    "General Alcohol Violation": [
        ...
        "{possessing} a malt beverage",
        "consuming alcohol in a public {place}",
        "{improper} {possessing} of alcohol",
        "{charged_with} public intoxication by the {place}",
        "{improper} consumption of alcohol",
        "selling alcohol to intoxicate a {minor}",
        "being {under_the_influence} in public",
    ],
    ...
    "Illicit Business": [
        ...
        "motor vehicle - operating a chop shop",
    ],
    "All Other Offenses": [
    ...
    "Forcible Sex Offense": [
        ...
        "{charged_with} receipt of child pornography",
        "{charged_with} transportation of child pornography",
        "{improper} possession of child pornography",
    ...
    "Aggravated Assault": [
        ...
        "serious {assault} in the first degree",
        "first degree {assault}",
        "third degree {assault} causing injuries to body",
        "second degree domestic {assault} with physical injury",
        ...
        "{assault} inflicting corporal injury on {family_member}",
        "{charged_with} {severe} {assault}",
        "domestic {assault} causing injuries to body",
        "{assault} on {family_member} causing injuries",
        "{assault} inflicting bruises on victim",
        "{assault} on {family_member} causing minor injuries",
    ...
    "Simple Assault": [
        ...
        "{assault} in the second degree",
        "second degree {assault}, not first degree",
        "{assault} - third degree",
        "{assault} but not in the first degree",
        "{charged_with} {assault} in the fourth degree",
        "{hit} someone in a {light} {fight} but caused no serious harm",
        "pushed a {victim} in an argument without injury",
        "verbal dispute escalated to {hit} but no injuries occurred",
        "{charged_with} simple {assault} after pushing {victim} at {place}",
        "{assault} with no {firearm}",
        "{assault} but no deadly weapon",
    ...
    "Fraud": [
        ...
        "knowingly making a false statement pertaining to {motor_vehicle} insurance requirements",
        "{charged_with} making a false statement for a purchase",
        "{improper} making of a false financial statement",
        "{charged_with} theft by {deception}",
        "using {deception} to take from {victim}",
    ...
    "Obstructing Justice": [
        ...
        "gave false {identification} without seeking financial gain",
    ...
    "Traffic Paperwork": [
        ...
        "{failure to} give notice to department of motor vehicles about change in address",
    ...
    "DUI": [
        ...
        "misdemeanor driving {under_the_influence}",
        "operating {under_the_influence}",
        "actual physical control of a vehicle {under_the_influence}",
    ],
    "Immigration": [
...
placeholder_options = {
    ...
    "family_member": ["spouse", "ex spouse", "family member", "wife", "husband", "girlfriend",
                      "sister", "mother", "cohabitant", "partner"],
    "raped": ["raped", "sexually assaulted", "forcing sex on", "assaulting sexually"],
    "strangled": ["choked", "strangled", "beat", "attacked", "assaulted", "stabbed", "punched unconscious", "suffocated"],
    ...
    "invalid": ["suspended", "invalid", "expired", "revoked", "canceled"],
    ...
    "drug": ["cocaine", "heroin", "marijuana", "drugs", "crack cocaine", "controlled substance",
             ...
             "drug", "marijana", "fentanyl", "narcotic drug", "schedule 2 drug", "schedule 4 substance"],
    ...
    "intimidating": ["intimidating", "intimidating", "threatening", "terrorizing", "coercing",
                     "menacing"],
    "deception": ["deception", "fraud", "trickery", "misrepresentation", "swindle", "false statement"],
}

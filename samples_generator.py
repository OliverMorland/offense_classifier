...
categories = {
    ...
    "Intimidation (Not Witness)": [
        ...
        "molesting an individual",
        "{charged_with} blackmailing a person",
        "using threatening language to family member",
        "making threats to an individual"
    ],
    "Burglary": [
    ...
    "Larceny/Motor Vehicle Theft": [
        ...
        "pickpocketed {stolen_property} from a shopper",
        ...
        "unlawful taking of {stolen_property}",
        "wrongful appropriation of {stolen_property}",
    ...
    "Other Property": [
        ...
        "vandalism",
        "property damage valued at $1000",
    ...
    "Court Violation": [
        "failed to appear in court for a scheduled hearing",
        ...
        "failed to pay court-mandated fines on time",
        "refused to comply with a restraining order issued by the court",
        ...
        "tampered with an electronic monitoring device",
        "failed to check in with a parole officer as required",
    ...
    "Rioting": [
        ...
        "creating public disorder through violent gathering",
        "participated in a chaotic demonstration at {place}",
        "attempted to incite a riot among bystanders",
        "setting vehicles on fire during a public disturbance",
        "gathering with intent to engage in violent acts",
        "tearing down fences and barricades in a mob",
        "hurling projectiles at law enforcement in a riot",
        "rioters smashing windows along {place}",
        "aggressively confronting authorities during public unrest",
        "damaging public property in a riot scenario",
        "rampaging through {place} in a violent crowd",
        "colluded to cause large-scale unrest at the demonstration"
    ],
    ...
    "Aggravated Assault": [
        ...
        "{strangled} passerby unconscious in a violent attack",
    ...
    "Weapons Offense": [
        ...
        "used a {weapon} without good reason",
        "discharge of a firearm close to a {place}",
        "fired a weapon near a {place}",
        "recklessly wielding of a {weapon}",
        "regulated {weapon} illegal possession",
        "illegal possession of a regulated {weapon}",
        "{charged_with} {possessing} a {weapon}",
        "{possessing} a {weapon} with an {invalid} license",
        "{charged_with} unregistered {weapon}",
        ...
        "use of {weapon} improperly",
        "{charged_with} weapons offense",
        "improper use of a {weapon}",
        "{reckless} operation of a {weapon}",
        "{reckless} use of a {weapon} by the {place}",
        ...
        "{charged_with} unlawful carrying of a concealed {weapon}",
        "illegal possession of a {weapon} by a prohibited person",
        "{charged_with} having an unlicensed firearm in a public space",
        "{charged_with} brandishing a {weapon} in a reckless manner",
        "discharged a firearm unlawfully near a {place}",
        ...
        "{charged_with} reckless discharge of a {weapon} endangering others",
    ...
    "Robbery": [
        ...
        "{charged_with} carjacking a {motor_vehicle} from a driver at gunpoint"
    ],
    "Extortion": [
        "threatened to release damaging information unless paid",
        "blackmailed someone for money",
        "forced someone to hand over property through threats",
        "demanded payment in exchange for withholding incriminating photos",
        "used intimidation to collect an unlawful debt",
        "coerced a {victim} into transferring funds under duress",
        "extorted local businesses for protection fees",
        "posed as official to get money from unsuspecting individuals",
        ...
        "blackmailed someone with personal secrets for gain",
        "forced signature on financial documents using intimidation",
        "attempted to extort a wealthy {victim}",
        "orchestrated a ransom scenario for personal profit",
        "warned victim of harm unless a payment was made",
        "illegally demanded hush money from a politician",
    ...
    "Hit and Run with Bodily Injury": [
        ...
        "sideswiped {victim}'s vehicle and disappeared",
    ...
    "Other Violent Offense": [
        "committed a violent act not classified elsewhere"
    ],
    "Arson": [
    ...
    "Fraud": [
        "committed financial fraud by falsifying documents",
        "engaged in identity theft to gain funds",
        "defrauded a {victim} out of money through false promises",
        "unlawful use of payment card under $1,500",
        "{charged_with} fraudulent use credit card",
        "fraud",
        "fraudulent use of a card",
        "defrauded a {victim}",
        "issued bogus checks to obtain property",
        "ran a pyramid scheme defrauding investors",
        "fabricated insurance claims for profit",
        "used counterfeit currency at {place}",
        "submitted fraudulent tax returns",
        "forged signatures on official paperwork",
        "{charged_with} unlawfully claimed government benefits using false information",
        "created a fake identity to make fraudulent purchases",
        "deceived a financial institution to secure a loan",
        "{charged_with} misrepresenting facts for monetary gain",
        "staged an accident to collect insurance money",
    ...
    "Escape/Flight": [
        ...
        "broke free from jail or detention",
        "{charged_with} evading arrest or detention",
        "escape/flight",
        "escape or flight",
        "attempt to run from a police officer",
        "flight from police",
        "ran away from officers",
        "{charged_with} running from police",
    ...
    "DUI": [
        ...
        "dui.",
        "aggravated driving {under_the_influence}",
        ...
        "driving while possessing alcohol",
        "driving while using alcohol",
    ...
    "Intimidating a Witness": [
        "threatened a witness to prevent them from testifying",
...
placeholder_options = {
    ...
    "under_the_influence": ["under the influence of alcohol", "intoxicated", "drunk", "high",
                            "in a drunken state", "in an intoxicated state"],
    "charged_with": ["charged with", "arrested for", "accused of", "indicted for", "under suspicion of"],
    "without": ["without", "no", "absent", "w/o"],
    "reckless": ["dangerous", "careless", "negligent", "reckless", "irresponsible"],
    ...
    "motor_vehicle": ["motorcycle", "car", "motor vehicle", "automobile", "truck"],
    "weapon": ["knife", "firearm", "weapon", "gun", "crossbow", "rifle", "lead pipe", "handgun"],
